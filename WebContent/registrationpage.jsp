...
<tr>
 <td>Birth Date(MM-DD-YYYY):</td><td><input path = "bithDate" class="birthdate" id="text" class="birthdate" required Placeholder="DD/MM/YYYY" /></td><td><span id="spanbirthdate"></span></td>
</tr>
<tr>
